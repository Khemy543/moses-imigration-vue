      ...
      <div class="container">
        <div class="row justify-content-center">
            <div class="col-12 col-xl-10 col-lg-10 col-md-10">
                ...
                <b>You may be eligible for an open work permit if, among other classes, you are:</b>
                <ul>
                  <li>The candidate must have work experience that qualifies them for the position. However,
                  ...
                  <li>The candidate must meet the educational criteria set by the program</li>
                  <li>The candidate must meet the language criteria as set by the program</li>
                  <li>Unless living and working within Canada, the candidate must prove that he/she and their
                    dependents have sufficient settlement funds
                  </li>
                </ul> <br><br>
                <b>Moses Canadian Immigration Consulting Services</b> can assist you in determining your
                eligibility of immigration to Canada through this program. <RouterLink
