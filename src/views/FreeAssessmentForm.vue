      ...
      <div class="row justify-content-center">
        <div class="col-12 col-xl-10 col-lg-10 col-md-10">
          <form action="email-templates/contact-form.php" method="post">
            <!-- <div>
                            <label for="">Category Interested For:</label>
                            <div class="row">
                                <div class="col-12 d-flex align-items-center">

                                    <div style="margin-right: 40px;">
                                        <input type="checkbox" value="Student visa">
                                        <label for="">Temporary Work</label>
                                    </div>

                                    <div style="margin-right: 40px;">
                                        <input type="checkbox" value="Student visa">
                                        <label for="">Electronic Travel</label>
                                    </div>
                                ...
                                <div class="d-flex ">
                                    ...
                                    <div style="margin-right: 40px;">
                                        <input type="checkbox" value="Student visa">
                                        <label for="">Visitor’s Visa</label>
                                    </div>
